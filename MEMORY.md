...
*One line per memory. The map, not the territory. Open a `memory/` file only when its line says it's relevant right now. How this works: `MEMORY-SYSTEM.md`.*

- [Who is Angel](memory/who-is-angel.md) — the captain: solo founder, steers/decides. Role only; personal facts stay private.
- [Banco is real production](memory/banco-is-real-production.md) — a real Swiss shop is in acceptance testing on it (not live yet); treat its data as production.
