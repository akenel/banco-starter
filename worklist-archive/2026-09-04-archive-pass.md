# Archive — the 2026-09-04 pass

*`WORKLIST.md` had grown to **2,307 lines** against its own ~280-line rule — the third pass, after
1,734 on 2026-08-13 and 1,201 on 2026-08-27. Everything below was moved out of it on the night of
2026-09-04, **verbatim, nothing edited**, and the split was verified line-for-line against the
pre-pass file: every line of the original is either still in `WORKLIST.md` or repeated here.*

*Why these and not others: each block below is a thread that CLOSED. What stayed in the live file
is the open work — ⓜ (birth year, parked on Felix), ⓞ (the counter visit), ⓒ5 (tonight’s close and
Pam’s open request), and the standing reference sections at the foot.*

---


## Contact sheet batch 1 — the 11 tablet shots, 2026-09-03

*(was `WORKLIST.md` lines 20–358 — ⓐ–ⓓ · the scale factor, the VAT bug, the pack badge)*
...
## ⓔ The frozen stylesheet was missing 131 classes

*(was `WORKLIST.md` lines 359–457 — closed by ⓙ)*
...
## ⓕ The pad judged a masked box as if it were money

*(was `WORKLIST.md` lines 458–520 — fixed)*
...
## ⓖ A refusal nobody can see — 139 buttons, and 33.33.3333

*(was `WORKLIST.md` lines 521–581 — fixed)*
...
## ⓗ The dead effect — every date box blind since it shipped

*(was `WORKLIST.md` lines 582–638 — fixed)*
...
## ⓘ The red box did not stop the save

*(was `WORKLIST.md` lines 639–675 — fixed)*
...
## ⓙ The 131 no-op classes — closed, and the chat bubble

*(was `WORKLIST.md` lines 676–776 — closed)*
...
## ⓚ The Search tab’s category picker

*(was `WORKLIST.md` lines 777–842 — fixed — and the ancestor of Pam’s B2 in ⓒ5)*
...
## ⓛ The gun pressed the button again

*(was `WORKLIST.md` lines 843–901 — fixed)*
...
## ⓝ Close of 2026-09-04 (daytime)

*(was `WORKLIST.md` lines 951–1005 — superseded by tonight’s close)*
...
## ⓒ2 mm/dd/yyyy on the six report filters

*(was `WORKLIST.md` lines 1082–1146 — fixed · 04446b1)*
...
## ⓒ3 Layla’s run of the date sheet

*(was `WORKLIST.md` lines 1147–1210 — 19 pass · 1 issue)*
...
## ⓒ4 The list, the controls, and two calls for Angel

*(was `WORKLIST.md` lines 1211–1256 — both answered — see ⓒ5)*
...
## 🔎 Found while fixing something else — 2026-09-02

*(was `WORKLIST.md` lines 1308–1343 — non-blocking, 3 days old)*
...
## 🌙 Where we stopped — 2026-09-03

*(was `WORKLIST.md` lines 1344–1401 — superseded)*
...
## 🌅 This week — from 2026-09-02

*(was `WORKLIST.md` lines 1402–1537 — superseded)*
...
*(was `WORKLIST.md` lines 1538–2164 — superseded)*
